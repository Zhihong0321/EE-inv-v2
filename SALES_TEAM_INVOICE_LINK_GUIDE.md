...
**Note:** Replace `quote.atap.solar` with your actual production domain (e.g., `quote.atap.solar`)
...
**Basic Format:**
```
https://quote.atap.solar/create-invoice?package_id=PACKAGE_ID&parameter1=value1&parameter2=value2
```

**Steps:**
1. Start with base URL: `https://quote.atap.solar/create-invoice`
...
// Usage
const link = buildInvoiceLink('https://quote.atap.solar/create-invoice', {
...
def build_invoice_link(base_url, package_id, **kwargs):
    ...
    Args:
        base_url: Base URL (e.g., 'https://quote.atap.solar/create-invoice')
...
**Link:**
```
https://quote.atap.solar/create-invoice?package_id=1703833647950x572894707690242050&customer_name=John%20Doe&customer_phone=60123456789&customer_address=123%20Main%20St%2C%20City
```
...
**Link:**
```
https://quote.atap.solar/create-invoice?package_id=1703833647950x572894707690242050&panel_qty=8&panel_rating=450W&discount_given=500%2010%25&customer_name=John%20Doe&customer_phone=60123456789&customer_address=123%20Main%20St&template_id=template_123
```
...
**Link:**
```
https://quote.atap.solar/create-invoice?package_id=1703833688009x793606512485335000&discount_given=10%25&customer_name=ABC%20Company&customer_phone=60123456789
```
...
**Link:**
```
https://quote.atap.solar/create-invoice?package_id=1703833788622x969335742275256300
```
...
**Link:**
```
https://quote.atap.solar/create-invoice?package_id=1703833647950x572894707690242050&panel_qty=8&panel_rating=450W&discount_given=1000
```
...
def generate_invoice_link_from_order(order):
    ...
    """
    base_url = "https://quote.atap.solar/create-invoice"
    params = {
...
# Returns: https://quote.atap.solar/create-invoice?package_id=...&discount_given=500%2010%25&...
```
